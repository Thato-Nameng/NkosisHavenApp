...
{
    public class DiagnosesDataService
    {
        private static readonly HttpClient _client = new HttpClient();  // Reuse HttpClient instance
        private readonly string apiUrl = "https://localhost:7069/api/Diagnoses";
        private readonly ILogger<DiagnosesDataService> _logger;


        public DiagnosesDataService(ILogger<DiagnosesDataService> logger)
        {
            _logger = logger;
        }
