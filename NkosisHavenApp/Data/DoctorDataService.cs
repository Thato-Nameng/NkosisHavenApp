...
namespace NkosisHavenApp.Data
{
    public class DoctorDataService
    {
        ...
        private readonly string apiUrl = "https://localhost:7069/api/Doctor";
        private readonly ILogger<DoctorDataService> _logger;


        public DoctorDataService(ILogger<DoctorDataService> logger)
        {
            _logger = logger;
        }
