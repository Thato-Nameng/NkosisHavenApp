...
namespace NkosisHavenApp.Data
{
    public class AppointmentDataService
    {
        ...
        private readonly string apiUrl = "https://localhost:7069/api/Appointment";
        private readonly ILogger<AppointmentDataService> _logger;


        public AppointmentDataService(ILogger<AppointmentDataService> logger)
        {
            _logger = logger;
        }
